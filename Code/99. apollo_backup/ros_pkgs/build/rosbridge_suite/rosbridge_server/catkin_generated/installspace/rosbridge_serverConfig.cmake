...
if("FALSE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /apollo/ros_pkgs/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /apollo/ros_pkgs/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /apollo/ros_pkgs/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/ros_pkgs/install/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
