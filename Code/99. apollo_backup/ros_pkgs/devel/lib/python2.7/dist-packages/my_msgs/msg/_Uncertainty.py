...
"""autogenerated by genpy from my_msgs/Uncertainty.msg. Do not edit."""
import sys
...
class Uncertainty(genpy.Message):
  ...
  _type = "my_msgs/Uncertainty"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """my_msgs/Point3D position_std_dev
...
float64 z"""
  ...
  _slot_types = ['my_msgs/Point3D','my_msgs/Point3D','my_msgs/Point3D','my_msgs/Point3D','my_msgs/Point3D']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.position_std_dev is None:
        self.position_std_dev = my_msgs.msg.Point3D()
      if self.orientation_std_dev is None:
        self.orientation_std_dev = my_msgs.msg.Point3D()
      if self.linear_velocity_std_dev is None:
        self.linear_velocity_std_dev = my_msgs.msg.Point3D()
      if self.linear_acceleration_std_dev is None:
        self.linear_acceleration_std_dev = my_msgs.msg.Point3D()
      if self.angular_velocity_std_dev is None:
        self.angular_velocity_std_dev = my_msgs.msg.Point3D()
    else:
      self.position_std_dev = my_msgs.msg.Point3D()
      self.orientation_std_dev = my_msgs.msg.Point3D()
      self.linear_velocity_std_dev = my_msgs.msg.Point3D()
