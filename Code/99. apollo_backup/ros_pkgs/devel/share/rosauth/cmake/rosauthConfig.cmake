...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /apollo/ros_pkgs/src/rosauth-0.1.7)
  set(rosauth_DEVEL_PREFIX /apollo/ros_pkgs/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /apollo/ros_pkgs/install)
...
if(NOT "/apollo/ros_pkgs/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/ros_pkgs/src/rosauth-0.1.7/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
