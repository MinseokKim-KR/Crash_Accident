...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_library_SOURCE_PREFIX /apollo/ros_pkgs/src/rosbridge_suite/rosbridge_library)
  set(rosbridge_library_DEVEL_PREFIX /apollo/ros_pkgs/devel)
  ...
  set(rosbridge_library_INSTALL_PREFIX /apollo/ros_pkgs/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbridge_library' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbridge_library' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/apollo/ros_pkgs/src/rosbridge_suite/rosbridge_library/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
