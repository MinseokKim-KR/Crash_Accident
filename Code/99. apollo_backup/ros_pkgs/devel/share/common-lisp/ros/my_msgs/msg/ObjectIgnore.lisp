...
(cl:defmethod cl:initialize-instance :after ((m <ObjectIgnore>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectIgnore)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<ObjectIgnore> is deprecated: use my_msgs-msg:ObjectIgnore instead.")))
