...
(cl:defmethod cl:initialize-instance :after ((m <LaneSegment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneSegment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<LaneSegment> is deprecated: use my_msgs-msg:LaneSegment instead.")))
...
(cl:defmethod start_s-val ((m <LaneSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:start_s-val is deprecated.  Use my_msgs-msg:start_s instead.")
  (start_s m))

(cl:ensure-generic-function 'end_s-val :lambda-list '(m))
(cl:defmethod end_s-val ((m <LaneSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:end_s-val is deprecated.  Use my_msgs-msg:end_s instead.")
  (end_s m))
