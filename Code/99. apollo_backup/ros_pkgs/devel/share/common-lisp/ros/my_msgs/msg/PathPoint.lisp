...
(cl:defclass <PathPoint> (roslisp-msg-protocol:ros-message)
  ((x
   ...
   (x_derivative
    :reader x_derivative
    :initarg :x_derivative
    :type cl:float
    :initform 0.0)
   (y_derivative
    :reader y_derivative
    :initarg :y_derivative
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PathPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<PathPoint> is deprecated: use my_msgs-msg:PathPoint instead.")))
...
(cl:defmethod kappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:kappa-val is deprecated.  Use my_msgs-msg:kappa instead.")
  (kappa m))
...
(cl:defmethod dkappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:dkappa-val is deprecated.  Use my_msgs-msg:dkappa instead.")
  (dkappa m))

(cl:ensure-generic-function 'ddkappa-val :lambda-list '(m))
(cl:defmethod ddkappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:ddkappa-val is deprecated.  Use my_msgs-msg:ddkappa instead.")
  (ddkappa m))

(cl:ensure-generic-function 'lane_id-val :lambda-list '(m))
(cl:defmethod lane_id-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:lane_id-val is deprecated.  Use my_msgs-msg:lane_id instead.")
  (lane_id m))

(cl:ensure-generic-function 'x_derivative-val :lambda-list '(m))
(cl:defmethod x_derivative-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:x_derivative-val is deprecated.  Use my_msgs-msg:x_derivative instead.")
  (x_derivative m))

(cl:ensure-generic-function 'y_derivative-val :lambda-list '(m))
(cl:defmethod y_derivative-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:y_derivative-val is deprecated.  Use my_msgs-msg:y_derivative instead.")
  (y_derivative m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathPoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'x_derivative))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'y_derivative))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathPoint>) istream)
  "Deserializes a message object of type '<PathPoint>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'x_derivative) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'y_derivative) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PathPoint>)))
  ...
  "7ea620c722d7c883fe3dec38ec5cac53")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PathPoint)))
  "Returns md5sum for a message object of type 'PathPoint"
  "7ea620c722d7c883fe3dec38ec5cac53")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PathPoint>))
  ...
  (cl:list 'PathPoint
    ...
    (cl:cons ':x_derivative (x_derivative msg))
    (cl:cons ':y_derivative (y_derivative msg))
))
