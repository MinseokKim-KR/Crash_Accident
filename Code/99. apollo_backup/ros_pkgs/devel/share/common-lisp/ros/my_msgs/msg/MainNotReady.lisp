...
(cl:defmethod cl:initialize-instance :after ((m <MainNotReady>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MainNotReady)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<MainNotReady> is deprecated: use my_msgs-msg:MainNotReady instead.")))
